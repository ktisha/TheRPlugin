      ...
      public void run() {
        ...
        application.runWriteAction(new Runnable() {
          ...
          public void run() {
            ...
            generateLibrary(TheRInterpreterConfigurable.THE_R_SKELETONS, skeletonLibraryPath, project);
            final String userSkeletonsPath = TheRHelpersLocator.getHelperPath("r-user-skeletons");
            generateLibrary(TheRInterpreterConfigurable.The_R_USER_SKELETONS, userSkeletonsPath, project);
          }
        });
