...
public class TheRHighlightingLexerTest extends TestCase {
  ...
  public void testAssignmentComment() {
    doTest("A <- a * 2  # R is case sensitive\n", "identifier", "SPACE", "<-", "SPACE", "identifier", "SPACE", "*", "SPACE", "numeric", "SPACE", "END_OF_LINE_COMMENT", "nl");
  }
  ...
  public void testCat() {
    doTest("cat(A, \"\\n\") # \"84\" is concatenated with \"\\n\"\n", "identifier", "(", "identifier", ",", "SPACE", "string", ")", "SPACE", "END_OF_LINE_COMMENT", "nl");
  }
  ...
  public void testDoubleBracketsSeparated() {
    doTest("return(invisible(dll_list[[ seq_along(dll_list)[ind] ]]))", "identifier", "(", "identifier", "(", "identifier", "[[", "SPACE", "identifier", "(", "identifier", ")", "[", "identifier", "]", "SPACE", "]]", ")", ")");
  }
  ...
  public void testIf() {
    doTest("if(A>a) # true, 84 > 42\n" +
           "{\n" +
           "  cat(A, \">\", a, \"\\n\")\n" +
           "} ", "if", "(", "identifier", ">", "identifier", ")", "SPACE", "END_OF_LINE_COMMENT", "nl", "{", "nl", "SPACE", "identifier", "(", "identifier", ",", "SPACE", "string", ",", "SPACE", "identifier", ",", "SPACE", "string", ")", "nl", "}", "SPACE");
  }
