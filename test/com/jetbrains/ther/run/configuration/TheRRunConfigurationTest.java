...
public class TheRRunConfigurationTest extends PlatformTestCase {
  ...
  public void testEnvsImmutability() {
    ...
    final TheRRunConfiguration runConfiguration = new TheRRunConfiguration(getProject(), CONFIGURATION_FACTORY);
  ...
  public void testCopyParams() {
    final TheRRunConfiguration runConfiguration1 = new TheRRunConfiguration(getProject(), CONFIGURATION_FACTORY);
    ...
    final TheRRunConfiguration runConfiguration2 = new TheRRunConfiguration(getProject(), CONFIGURATION_FACTORY);

    TheRRunConfiguration.copyParams(runConfiguration1, runConfiguration2);
