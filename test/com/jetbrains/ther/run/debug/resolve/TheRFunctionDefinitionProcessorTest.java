...
public class TheRFunctionDefinitionProcessorTest extends PlatformTestCase {

  public void testNotFunction() throws IOException {
    final String text = "x <- c(1:3)";
    final TheRFunctionDescriptor root = calculateRootDescriptor(text);
  ...
  public void testFunction() throws IOException {
    ...
    final TheRFunctionDescriptor root = calculateRootDescriptor(text);
    final Map<String, List<TheRFunctionDescriptor>> rootChildren = root.getChildren();

    assertEquals(1, rootChildren.size());
    assertEquals(1, rootChildren.get("f").size());

    final TheRFunctionDescriptor f = rootChildren.get("f").get(0);
  ...
  public void testInnerFunction() throws IOException {
    ...
    final TheRFunctionDescriptor d = f.getChildren().get("d").get(0);
  ...
  public void testInnerInnerFunction() throws IOException {
    ...
    final TheRFunctionDescriptor g = d.getChildren().get("g").get(0);
  ...
  public void testOverriddenFunction() throws IOException {
    ...
    final TheRFunctionDescriptor f1 = rootChildren.get("f").get(0);
    ...
    final TheRFunctionDescriptor f2 = rootChildren.get("f").get(1);
  ...
  @NotNull
  private TheRFunctionDescriptor calculateRootDescriptor(@NotNull final String text) throws IOException {
    ...
    final TheRFunctionDefinitionProcessor processor = new TheRFunctionDefinitionProcessor(document);
