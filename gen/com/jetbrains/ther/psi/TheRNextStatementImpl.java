...
public class TheRNextStatementImpl extends TheRExpressionImpl implements TheRNextStatement {

  public TheRNextStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof TheRVisitor) ((TheRVisitor)visitor).visitNextStatement(this);
